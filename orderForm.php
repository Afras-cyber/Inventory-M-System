...
<div class="container-fluid sale-for-sale">
        ...
        <form action="">
            ...
            <div class="row ">
                ...
                <br>
            <div class="row">
                <div class="col-4"><label class="label">Supplier Name</label><input type="number" class="input_invoice" name="cust_name"></div>
                <div class="col-4"><label class="label">Supplier ID</label><input type="number" class="input_invoice" name="cust_id"></div>                
                <div class="col-1"></div>
